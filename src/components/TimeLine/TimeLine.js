...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        Coding was always a passion of mine. I always enjoyed solving problems.
        I thought it would be cool if I could use my passion to help others solve their problems too!
      </SectionText>
